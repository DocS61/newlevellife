    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center">
        ...
        >
          ...
          <h2 className="font-display text-xl font-semibold mb-2">Seite nicht gefunden</h2>
          <p className="text-muted-foreground mb-6 max-w-sm mx-auto">Die gesuchte Seite existiert leider nicht. Vielleicht suchst du nach einem Namen?</p>
          <Link
            href="/"
